...
# a = np.load('./image_dataset/mnist_subset_1024.npz')
# get_subset_images(torch.from_numpy(a['x_train']), torch.from_numpy(a['y_train']), num_select = 1024, save = True, tds_dir = './image_dataset/')
...
def load_tt_im():
    tt_dataset = np.load(mnist_path + "/mnist_subset_1024.npz")
